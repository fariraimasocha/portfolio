...
[10x](https://10x.fariraimasocha.co.zw/) ([GitHub](https://github.com/fariraimasocha/10x)) is a skill pack for Claude Code and Codex that turns "this UI feels off" into a concrete, reviewable set of fixes. It ships seven focused skills — typography, color, spacing, depth, motion, responsive, and a `polish` orchestrator — that an AI agent can run against any frontend codebase to surface inconsistencies and propose edits.
...
Visit [10x.fariraimasocha.co.zw](https://10x.fariraimasocha.co.zw/) · Source on [GitHub](https://github.com/fariraimasocha/10x).
